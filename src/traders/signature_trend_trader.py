...
import ccxt
from ..strategies.signature_trend import SignatureTrendStrategy
import logging
import time

class SignatureTrendTrader:
    def __init__(self, exchange: str, symbol: str, api_key: str, api_secret: str):
        ...
        self.symbol = symbol
        self.strategy = SignatureTrendStrategy()
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('logs/signature_trend_trader.log'),
    ...
    def run(self):
        """트레이딩 루프를 실행합니다."""
        self.logger.info("시그니처 추세 추종 트레이더 시작")
